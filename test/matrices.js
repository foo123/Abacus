...
echo(o.toString());
echo('o.inv().toString()');
echo(o.inv().toString(), o.mul(o.inv()).equ(Abacus.Matrix.I(ring.associatedField(), 3)));
echo('o.adj().toString()');
echo(o.adj().toString(), o.mul(o.adj()).equ(Abacus.Matrix.I(ring, 3)));
...
echo(o.toString());
echo('o.inv().toString()');
echo(o.inv().toString(), o.mul(o.inv()).equ(Abacus.Matrix.I(ring.associatedField(), 2)));
echo('o.adj().toString()');
echo(o.adj().toString(), o.mul(o.adj()).equ(Abacus.Matrix.I(ring, 2).mul(o.det())));
echo('o.charpoly().toString()');
echo(o.charpoly().toString());
o.dispose();
echo();
...
echo(o.toString());
echo('o.inv().toString()');
echo(o.inv().toString(), o.inv().mul(o).equ(Abacus.Matrix.I(ring.associatedField(), 3)));
...
echo(o.rref().toString());
echo('o.inv().toString()');
echo(o.inv().toString(), o.inv().mul(o).equ(Abacus.Matrix.I(ring.associatedField(), 2)));
echo('o.charpoly("y").toString()');
echo(o.charpoly("y").toString());
o.dispose();
echo('---');
