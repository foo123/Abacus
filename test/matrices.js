...
echo('o=Abacus.Matrix(ring, [[3,3,1,4],[0,1,0,0],[0,0,19,16],[0,0,0,3]])');
o=Abacus.Matrix(ring, [[3,3,1,4],[0,1,0,0],[0,0,19,16],[0,0,0,3]]);
echo('o.toString()');
echo(o.toString());
echo('o.hnf()');
m=o.hnf();
...
echo(m[1].toString());
echo("Check:");
echo(m[1].mul(o).toString(), m[1].mul(o).equ(m[0]));
echo('o=Abacus.Matrix(ring, [[2,3,6,2],[5,6,1,6],[8,3,1,1]])');
o=Abacus.Matrix(ring, [[2,3,6,2],[5,6,1,6],[8,3,1,1]]);
echo('o.toString()');
echo(o.toString());
echo('o.hnf()');
m=o.hnf();
