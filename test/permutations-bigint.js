...
echo(o.item(Abacus.Arithmetic.BigInt("78043612608166064768844377641568960512000000000000"),"lex"));

echo('o.item(78043612608166064768844377641568960512000000000000,"colex")');
echo(o.item(Abacus.Arithmetic.BigInt("78043612608166064768844377641568960512000000000000"),"colex"));

echo('o.item(78043612608166064768844377641568960512000000000000,"revlex")');
echo(o.item(Abacus.Arithmetic.BigInt("78043612608166064768844377641568960512000000000000"),"revlex"));

echo('o.item(78043612608166064768844377641568960512000000000000,"revcolex")');
echo(o.item(Abacus.Arithmetic.BigInt("78043612608166064768844377641568960512000000000000"),"revcolex"));
